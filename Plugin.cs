...
namespace RealismMod
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void initConfigs()
        {
            ...
            UseMouseWheelStance = Config.Bind<bool>(stanceBinds, "Enable Mousewheel Stance Switching", ServerConfig.enable_stances, new ConfigDescription("Switches Between High And Low Ready Via Mouse Wheel.", null, new ConfigurationManagerAttributes { Order = 160, Browsable = ServerConfig.enable_stances }));
