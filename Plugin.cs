...
/*                    new GetMalfunctionStatePatch().Enable();*/
     ...
     /*       new RotatePatch().Enable();*/
        ...
        private void initConfigs()
        {
            ...
            GainCutoff = Config.Bind<float>(deafSettings, "Headset Gain Cutoff Multi.", 1f, new ConfigDescription("How Much Headset Gain Is Reduced By While Firing. 0.75 = 25% Reduction.", new AcceptableValueRange<float>(0f, 2f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 10 }));
