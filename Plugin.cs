...
namespace RealismMod
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void initConfigs()
        {
            ...
            RecoilRandomness = Config.Bind<float>(advancedRecoilSettings, "Recoil Randomness", 5f, new ConfigDescription("Higher = Recoil Bounces Around More, More Erratic Recoil Pattern", new AcceptableValueRange<float>(0f, 10f), new ConfigurationManagerAttributes { Order = 135, Browsable = ServerConfig.recoil_attachment_overhaul }));
            ...
            DeafRate = Config.Bind<float>(deafSettings, "Deafen Rate", 0.006f, new ConfigDescription("How Quickly Player Gets Deafened. Higher = Faster.", new AcceptableValueRange<float>(0f, 1f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 7, IsAdvanced = true, Browsable = ServerConfig.headset_changes }));
            DeafReset = Config.Bind<float>(deafSettings, "Deafen Reset Rate.", 0.08f, new ConfigDescription("How Quickly Player Regains Hearing. Higher = Faster.", new AcceptableValueRange<float>(0f, 1f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 6, IsAdvanced = true, Browsable = ServerConfig.headset_changes }));
