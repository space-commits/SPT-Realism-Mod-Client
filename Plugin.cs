...
namespace RealismMod
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void initConfigs()
        {
            ...
            ConvergenceSpeedCurve = Config.Bind<float>(advancedRecoilSettings, "Convergence Curve Multi", 1f, new ConfigDescription("The Convergence Curve. Lower Means More Recoil.", new AcceptableValueRange<float>(0.01f, 1.5f), new ConfigurationManagerAttributes { Order = 5 }));
            ResetTime = Config.Bind<float>(advancedRecoilSettings, "Reset Delay", 0.14f, new ConfigDescription("The Time In Seconds That Has To Be Elapsed Before Firing Is Considered Over, Recoil Will Not Reset Until It Is Over.", new AcceptableValueRange<float>(0.1f, 0.5f), new ConfigurationManagerAttributes { Order = 4 }));
            ...
            RandomnessMulti = Config.Bind<float>(advancedRecoilSettings, "Randomness Multi", 0.0f, new ConfigDescription("Recoil Amount Shot-To-Shot Is 'Random' Within A Range, Lower Value = Less Randomness.", new AcceptableValueRange<float>(0f, 1.9f), new ConfigurationManagerAttributes { Order = 1 }));
            ...
            ActiveAimResetSpeedMulti = Config.Bind<float>(activeAim, "Active Aim Reset Speed Multi", 10.0f, new ConfigDescription("", new AcceptableValueRange<float>(1f, 100f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 142, IsAdvanced = true }));
