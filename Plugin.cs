...
namespace RealismMod
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public void InitConfigs()
        {
            ...
            GlobalUBGLReloadMulti = Config.Bind<float>(Speed, "UBGL Reload Speed Multi", 1.0f, new ConfigDescription("", new AcceptableValueRange<float>(0.1f, 2.0f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 13, IsAdvanced = true }));
