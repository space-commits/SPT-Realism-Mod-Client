...
namespace RealismMod
{
    public static class HazardZoneLocations
    {
        ...
        private static Dictionary<string, (float spawnChance, float strength, Vector3 position, Vector3 rotation, Vector3 size)> CustomsGasZones = new Dictionary<string, (float spawnChance, float strength, Vector3, Vector3, Vector3)>
        {
            ...
            { "CustomsPumpWarehouse", (0f, 150f, new Vector3(557f, 1.5f, -120.5f), new Vector3(0f, 7f, 0f), new Vector3(40f, 15f, 23f)) },
            { "CustomsPumpRoom", (0f, 100f, new Vector3(612f, 1.5f, -129.8f), new Vector3(0f, 6f, 0f), new Vector3(23.5f, 6.5f, 15f)) },
            { "CustomsWarehouse3", (0f, 150f, new Vector3(391.5f, 1f, -97f), new Vector3(0f, 8.5f, 0f), new Vector3(53.5f, 6.5f, 29f)) },
        };
        ...
        private static Dictionary<string, (float spawnChance, float strength, Vector3 position, Vector3 rotation, Vector3 size)> StreetsZones = new Dictionary<string, (float spawnChance, float strength, Vector3, Vector3, Vector3)>
        {
            ...
            { "StreetsFactoryCourtyard", (5f, 120f, new Vector3(-111f, 2.2f, 275f), new Vector3(0f, 0f, 0f), new Vector3(30f, 3f, 16f)) },
            { "StreetsFactoryMain", (5f, 120f, new Vector3(-120f, 2.2f, 288.5f), new Vector3(0f, 0f, 0f), new Vector3(34f, 4.8f, 11f)) },
            { "StreetsFactoryUpper", (5f, 120f, new Vector3(-120f, 10f, 288.5f), new Vector3(0f, 0f, 0f), new Vector3(34f, 4f, 11f)) },
            { "StreetsTerragroupOffice1", (0f, 200f, new Vector3(53f, 1f, -74f), new Vector3(0f, 0f, 0f), new Vector3(22f, 2f, 13f)) },
            { "StreetsTerragroupOffice2", (0f, 200f, new Vector3(60f, 1f, -62f), new Vector3(0f, 0f, 0f), new Vector3(15f, 2f, 9f)) },
            { "StreetsTerragroupOffice3", (0f, 200f, new Vector3(45.5f, 1f, -53.5f), new Vector3(0f, 0f, 0f), new Vector3(8.5f, 2f, 14f)) },
        };
        ...
        private static Dictionary<string, (float spawnChance, float strength, Vector3 position, Vector3 rotation, Vector3 size)> LighthouseGasZones = new Dictionary<string, (float spawnChance, float strength, Vector3, Vector3, Vector3)>
        {
            ...
            { "LighthouseDrugLab", (0f, 100f, new Vector3(-119f, 10.5f, -841f), new Vector3(0f, 0f, 0f), new Vector3(15f, 4f, 10f)) },
        ...
        private static Dictionary<string, (float spawnChance, float strength, Vector3 position, Vector3 rotation, Vector3 size)> WoodsGasZones = new Dictionary<string, (float spawnChance, float strength, Vector3, Vector3, Vector3)>
        {
            ...
            { "WoodsBodiesContainer", (0f, 25f, new Vector3(-201.8f, -1f, 233.7f), new Vector3(0f, -27f, 0f), new Vector3(2f, 2.5f, 12f)) }
        };
        ...
        private static Dictionary<string, (float spawnChance, float strength, Vector3 position, Vector3 rotation, Vector3 size)> CustomsRadZones = new Dictionary<string, (float spawnChance, float strength, Vector3, Vector3, Vector3)>
        {
            ...
            { "CustomsMarkedRoom", (0f, 100f, new Vector3(183.5f, 7f, 182f), new Vector3(0f, 7f, 0f), new Vector3(6.5f, 3f, 6f)) },
        };
        ...
        {
             { "StreetsMarked1", (0f, 100f, new Vector3(-131f, 8.8f, 269f), new Vector3(0f, 0f, 0f), new Vector3(6f, 3f, 13.5f)) },
             { "StreetsMarked2", (0f, 100f, new Vector3(182f, 0f, 226.5f), new Vector3(0f, 0f, 0f), new Vector3(18f, 3f, 10f)) },
             { "StreetsMarked3", (0f, 200f, new Vector3(203f, 0f, 228f), new Vector3(0f, 0f, 0f), new Vector3(15f, 2f, 8.5f)) },
             { "StreetsXray", (0f, 200f, new Vector3(185.5f, 2f, 102f), new Vector3(0f, 0f, 0f), new Vector3(8f, 2.5f, 5.5f)) },
        };
        ...
        {
            { "LabsGreenGoo", (0f, 50f, new Vector3(-173f, 2.5f, -371), new Vector3(0f, 0f, 0f), new Vector3(12f, 5f, 14f)) },
            { "LabsAreaAroundGoo", (0f, 200f, new Vector3(-174f, 2.5f, -367), new Vector3(0f, 0f, 0f), new Vector3(40f, 4f, 35f)) },
            { "LabsGooBarrels", (0f, 200f, new Vector3(-174f, 2.5f, -355f), new Vector3(0f, 0f, 0f), new Vector3(5f, 5f, 5f)) },
            { "LabsGreen", (0f, 200f, new Vector3(-131f, 6f, -366f), new Vector3(0f, 0f, 0f), new Vector3(17.5f, 5f, 25f)) },
            { "LabsBlack", (0f, 200f, new Vector3(-131f, 1f, -357.5f), new Vector3(0f, 0f, 0f), new Vector3(19f, 4.5f, 12f)) },
            { "LabsBlue1", (0f, 200f, new Vector3(-133f, 1.5f, -400.5f), new Vector3(0f, 0f, 0f), new Vector3(14f, 3f, 11f)) },
            { "LabsBlue2", (0f, 100f, new Vector3(-124.5f, 1.5f, -397f), new Vector3(0f, 0f, 0f), new Vector3(6.5f, 3f, 7f)) },
        };
        ...
        {
            { "LighthouseLighthouseBasement", (0f, 100f, new Vector3(440f, 20.5f, 460f), new Vector3(0f, 15f, 0f), new Vector3(13f, 6f, 10f)) },
            { "LighthouseLighthouse1", (0f, 250f, new Vector3(440f, 24f, 460f), new Vector3(0f, 15f, 0f), new Vector3(8f, 2f, 8f)) },
            { "LighthouseCultRoom1", (0f, 250f, new Vector3(444f, 29f, 463f), new Vector3(0f, 15f, 0f), new Vector3(6f, 2f, 7f)) },
        };
        ...
        {
             { "WooodsMarked1", (0f, 100f, new Vector3(-89f, 12f, -717f), new Vector3(0f, 0f, 0f), new Vector3(5f, 3f, 5f)) },
             { "WooodsMarkedShed", (0f, 100f, new Vector3(-80f, 12f, -726f), new Vector3(0f, 25f, 0f), new Vector3(5f, 5f, 5f)) },
             { "WooodsMarked2", (0f, 100f, new Vector3(195.6f, 0.2f, -7f), new Vector3(0f, 25f, 0f), new Vector3(7f, 3f, 7f)) },
             { "WoodsMountainBunker1", (0f, 50f, new Vector3(-164.1f, 46f, -235.5f), new Vector3(0f, -20f, 0f), new Vector3(15f, 2.5f, 5f)) },
             { "WoodsMountainBunkerDoor", (0f, 50f, new Vector3(-156f, 51f, -273f), new Vector3(0f, -20f, 0f), new Vector3(10f, 2.5f, 5f)) }
        };
