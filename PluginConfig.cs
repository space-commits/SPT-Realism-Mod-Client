...
namespace RealismMod
{
    public static class PluginConfig
    {
        ...
        public static void InitConfigBindings(ConfigFile config)
        {
            ...
            GasMaskBreathVolume = config.Bind<float>(zoneSettings, "Gas Mask Breath Volume", 0.45f, new ConfigDescription("Volume Modifier For Gas Mask SFX.", new AcceptableValueRange<float>(0f, 2f), new ConfigurationManagerAttributes { Order = 20, Browsable = Plugin.ServerConfig.enable_hazard_zones }));
