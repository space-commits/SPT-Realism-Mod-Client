...
namespace RealismMod
{
    public static class PluginConfig
    {
        ...
        public static void InitConfigBindings(ConfigFile config)
        {
            ...
            ADSVolume = config.Bind<float>(deafSettings, "ADS Volume Multi", 1f, new ConfigDescription("ADS Volume.", new AcceptableValueRange<float>(0f, 10f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 35, IsAdvanced = false, Browsable = Plugin.ServerConfig.headset_changes }));
            GunshotVolume = config.Bind<float>(deafSettings, "Gunshot Volume", 0.9f, new ConfigDescription("Multiplier For Gunshot Volume.", new AcceptableValueRange<float>(-50f, 5f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 30, IsAdvanced = false, Browsable = Plugin.ServerConfig.headset_changes }));
