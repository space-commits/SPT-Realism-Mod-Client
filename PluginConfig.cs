...
namespace RealismMod
{
    public static class PluginConfig
    {
        ...
        public static void InitConfigBindings(ConfigFile config)
        {
            ...
            OutdoorAmbientMulti = config.Bind<float>(deafSettings, "Outdoor Ambient Audio Offset", 0f, new ConfigDescription("Adjusts The Ambient Volume With And Without Headsets. Higher = Louder.", new AcceptableValueRange<float>(-60f, 20f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 70, Browsable = Plugin.ServerConfig.headset_changes }));
