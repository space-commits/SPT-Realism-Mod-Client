...
namespace RealismMod
{
    public static class PluginConfig
    {
        ...
        public static void InitConfigBindings(ConfigFile config)
        {
            ...
            GunshotVolume = config.Bind<float>(deafSettings, "Gunshot Volume", 0.6f, new ConfigDescription("Multiplier For Gunshot Volume, Player and NPC.", new AcceptableValueRange<float>(0f, 2f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 80, IsAdvanced = false, Browsable = Plugin.ServerConfig.headset_changes }));
            AmbientMulti = config.Bind<float>(deafSettings, "Ambient Audio Modifier", 0f, new ConfigDescription("Adjusts The Ambient Volume With And Without Headsets.", new AcceptableValueRange<float>(-20f, 20f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 70, Browsable = Plugin.ServerConfig.headset_changes }));
            ...
            ADSVolume = config.Bind<float>(deafSettings, "ADS Volume Multi", 2.5f, new ConfigDescription("ADS Volume.", new AcceptableValueRange<float>(0f, 10f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 20, IsAdvanced = false, Browsable = Plugin.ServerConfig.headset_changes }));
