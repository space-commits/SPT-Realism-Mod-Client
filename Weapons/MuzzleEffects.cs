...
namespace RealismMod
{
    ...
    //modify visual effects of muzzles to factor in the muzzle device etc.
    public class MuzzleEffectsPatch : ModulePatch
    {
        ...
        private static void Prefix(WeaponManagerClass __instance)
        {
            ...
            float enviroFactorFlash = PlayerValues.EnviroType == EnvironmentType.Indoor ? 1.19f : 1f;
            ...
            float enviroFactorFlame = PlayerValues.EnviroType == EnvironmentType.Indoor ? 1.142f : 1f;
            ...
            float enviroFactorSmoke = PlayerValues.EnviroType == EnvironmentType.Indoor ? 1.24f : 0.85f;
